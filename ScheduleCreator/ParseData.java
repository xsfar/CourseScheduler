...
public class ParseData {
    ...
    protected static void applyRegex(String _semester, String _pickRegex) throws IOException {
        {
            ...
            while (match.find()) {
                ...
                /**
                 * This if else statement will format the output based on which
                 * regex was used, currently there is only a method to format
                 * one of the regexs outputs.
                 */
                if (_pickRegex == regexUsefulInfo) {
                    ...
                    ParseData.formatRegexEverything(input);
                }
    ...
    protected static void formatRegexEverything(String input) throws IOException {
         ...
         */
        String newresult = input.replaceAll("\\(P\\)", "\n");
        /*
         ...
         */
        String nnewresults = newresult.replaceAll("(	Lecture|	Lab|	Individual Study|	Seminar|	Clinical|Colloquia|	Dissertation or Thesis|	Ensemble|	Internship, Field Exp, Coop Ed|	Lecture and lab|	Performance|	Physical Activity|	Practicum - Dlvrd Ind Setting|	Recitations|	Student Teaching|	Studio|	Lecture and Lab|	Dissertation or Thesis)", " = ");
        System.out.print(nnewresults);

    }

    /**
     * Returns all parsed data using the "regexEverything"(refer to the
     * "regexEverything" variable comment)
     *
    ...
    protected static void getAllData(String _semester) throws IOException {
         ...
         */
        applyRegex(_semester, regextest);
    }
